    ...
    render(filtered, magnify, party, geo, race, data) {
        var self = this;
            ...
            //draw shift lines
                    ...
                    .attr("stroke", 
                    function (d, i){ 
                        if (features[i].properties.COUNTYCODE == "1" || features[i].properties.COUNTYCODE == "3") { return "#7f98aa"; }
                        else { return "#8c0808"; } 
                    })
                    .attr("stroke-width", "1px")
                    .attr("class", "shifter")
                    ...
                    .attr("x2", function (d, i){ 
                        if (features[i].properties.COUNTYCODE == "1" || features[i].properties.COUNTYCODE == "3") { return  d[0] - 10; }
                        else { return  d[0] + 10; } 
                    })
